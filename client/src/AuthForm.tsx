...
export function AuthForm() {
  ...
  const [form, setForm] = useState({
    login: "", password: "", email: "", newPassword: "", newConfirm: "",
  });
  ...
  async function submit() {
    ...
    const err = await login(form.login, form.password, rememberMe);
    setSubmitting(false);
      ...
      <AnimatePresence mode="wait">
        {mode === "register" ? (
          <motion.div
            ...
            transition={SPRING}
          >
            <RegisterStepper onSwitch={() => { setMode("login"); setStatus(null); }} />
          </motion.div>
        ) : (
          <motion.div
            key={mode}
          ...
          >
            ...
            {mode === "login" && (
              <button onClick={() => { setMode("register"); setStatus(null); }} className="text-sm text-muted hover:text-fg transition">
