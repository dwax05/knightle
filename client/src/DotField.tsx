...
const DotField = memo(({
  ...
  propsRef.current = { dotRadius, dotSpacing, cursorRadius, cursorForce, bulgeOnly, bulgeStrength, sparkle, waveAmplitude, gradientFrom, gradientTo, returnSpeed };
    ...
    function tick() {
      ...
      for (let i = 0; i < len; i++) {
        ...
        if (distSq < crSq && eng > 0.01) {
          ...
          const rs = p.returnSpeed as number;
          d.sx += (d.ax - d.sx) * rs;
          d.sy += (d.ay - d.sy) * rs;
        }
